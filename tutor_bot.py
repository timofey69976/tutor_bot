...
"""Клавиатура выбора предметов - ТОЛЬКО ОДИН ПРЕДМЕТ"""
...
callback.message.text + "\n\n✅ *Занятие подтвержено и добавлено в расписание*",

parse_mode="Markdown"

)

# ✅ ВОССТАНОВЛЕНИЕ КЛАВИАТУРЫ - ДОБАВЛЕНО
...
await callback.answer("✅ Занятие подтвержено!")
